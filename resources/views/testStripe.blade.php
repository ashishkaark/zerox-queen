  ...
  <body>
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <!-- Payment form -->
            <form action="{{url('/handle-payment')}}" method="POST" id="paymentFrm">
                @csrf
