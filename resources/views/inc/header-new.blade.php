...
<header class="show_monble_view" id="header_mob">
    <nav class="navbar navbar-expand-lg navbar-light bg-light" id="">
        ...
        <div class="queen">
            ...
            <button style="border: 0px solid #fff" class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                {{-- <span class="navbar-toggler-icon"></span> --}}
    ...
    <div class=" d-flex align-items-center my-0 py-0 px-5">
        ...
        <div class="d-flex justify-content-center align-content-center">
            ...
            {{-- <div class="nav-button ">
                <a href="signin.html" class="mr-1"><img src="{{asset('images/icon/heart.svg')}}" class="img-fluid" alt=""></a>
            </div> --}}
